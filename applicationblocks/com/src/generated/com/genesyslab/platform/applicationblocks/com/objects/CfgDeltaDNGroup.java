...
public class CfgDeltaDNGroup extends CfgDelta {
     ...
     */
    public CfgDeltaDNGroup(final IConfService confService) {
        super(confService, "CfgDeltaDNGroup");
    }
    ...
    /**
     * The DBID of the target CfgDNGroup configuration object.
     *
     ...
     */
    public final CfgDNGroup retrieveCfgDNGroup() throws ConfigException {
        return (CfgDNGroup) (super.retrieveObject());
    }
     ...
     */
    public final Collection<CfgDNInfo> getDeletedDNs() {
        return (Collection<CfgDNInfo>) getProperty("deletedDNDBIDs");
    }
     ...
     */
    public final Collection<CfgDNInfo> getAddedDNs() {
        return (Collection<CfgDNInfo>) getProperty("addedDNs");
    }
     ...
     * @return list of structures or null
     */
    public final Collection<CfgDNInfo> getChangedDNs() {
        return (Collection<CfgDNInfo>) getProperty("changedDNs");
    }
}
