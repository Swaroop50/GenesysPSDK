 ...
 * <a href="CfgRole.html">CfgRole</a>
 * </code> object.
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgDeltaRole extends CfgDelta {
     ...
     */
    public CfgDeltaRole(final IConfService confService) {
        super(confService, "CfgDeltaRole");
    }
    ...
    /**
     * The DBID of the target CfgRole configuration object.
     *
     ...
     */
    public final CfgRole retrieveCfgRole() throws ConfigException {
        return (CfgRole) (super.retrieveObject());
    }
     ...
     */
    public final Collection<CfgRoleMember> getAddedMembers() {
    ...
    /**
     * A pointer to the list of deleted role members. Has the same structure as parameter members.
     *
     * @return list of structures or null
     */
    public final Collection<CfgRoleMember> getDeletedRoleMembers() {
        return (Collection<CfgRoleMember>) getProperty("deletedRoleMembers");
    }

    /**
     * A pointer to the list of role members whose values have been changed. Has the same structure as parameter members.
     *
     * @return list of structures or null
     */
    public final Collection<CfgRoleMember> getChangedRoleMembers() {
        return (Collection<CfgRoleMember>) getProperty("changedRoleMembers");
    }
}
