...
public class CfgMemberID extends CfgStructure {
    /**
     ...
     * @param parent instance of configuration object as a parent for this structure instance
     */
    public CfgMemberID(final IConfService confService, final ICfgObject parent) {
        super(confService, new ConfStructure(
                (CfgDescriptionStructure) confService.getMetaData()
                        .getCfgClass("CfgMemberID")), parent);
    }


    @SuppressWarnings("unchecked")
    final void checkPropertiesForSave() throws ConfigException {
            if (getMetaData().getAttribute("DBID") != null) {
                if (getProperty("DBID") == null) {
                    throw new ConfigException("Mandatory property 'DBID' not set.");
                }
            }
    }
