...
public class CfgACE extends CfgStructure {
    /**
     ...
     * @param parent instance of configuration object as a parent for this structure instance
     */
    public CfgACE(final IConfService confService, final ICfgObject parent) {
        super(confService, new ConfStructure(
                (CfgDescriptionStructure) confService.getMetaData()
                        .getCfgClass("CfgACE")), parent);
    }
    ...
    final void checkPropertiesForSave() throws ConfigException {
            if (getMetaData().getAttribute("ID") != null) {
                CfgACEID ID = (CfgACEID) getProperty("ID");
                if (ID != null) {
                    ID.checkPropertiesForSave();
                }
            }
    }

    public final CfgACEID getID() {
        return (CfgACEID) getProperty(CfgACEID.class, "ID");
    }

    public final void setID(final CfgACEID value) {
        setProperty("ID", value);
    }

    public final Integer getAccessMask() {
        return (Integer) getProperty("accessMask");
    }

    public final void setAccessMask(final Integer value) {
        setProperty("accessMask", value);
    }
}
