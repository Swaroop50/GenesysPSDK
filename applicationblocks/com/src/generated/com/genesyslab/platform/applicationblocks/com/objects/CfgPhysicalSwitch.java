 ...
 *
 * <p/>
 * A physical switch cannot be deleted as long as it is
 * associated with at least one switch (see <code>
 * <a href="CfgSwitch.html">CfgSwitch</a>
 * </code>).
 *
 * <br/><br/><font size="+1"><strong>See also:</strong></font><p>
 * <a href="CfgDeltaPhysicalSwitch.html">
 * <b>CfgDeltaPhysicalSwitch</b>
 * </a>
 * </p>
 */
...
public class CfgPhysicalSwitch
            extends CfgObject {

    public static final CfgObjectType OBJECT_TYPE = CfgObjectType.CFGPhysicalSwitch;
    ...
    public CfgPhysicalSwitch(
        ...
        if (objData.getObjectType() != OBJECT_TYPE) {
            throw new IllegalArgumentException(
                    "Incompatible object type for CfgPhysicalSwitch - "
     ...
     * @param confService configuration service instance
     */
    public CfgPhysicalSwitch(final IConfService confService) {
        super(confService,
    ...
    /**
     * <p/>
     * Type of this physical switch. Mandatory.
     * Once specified, cannot be changed. See
     * <code>
     ...
     * @see #getType()
     */
    public final void setType(final CfgSwitchType value) {
        if (isSaved()) {
            throw new ConfigRuntimeException(
                "Can't set this property because containing object has been saved.");
        }
