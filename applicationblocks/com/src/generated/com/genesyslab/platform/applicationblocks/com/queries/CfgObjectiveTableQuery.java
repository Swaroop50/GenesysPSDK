 ...
 * @see com.genesyslab.platform.applicationblocks.com.objects.CfgObjectiveTable
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgObjectiveTableQuery extends CfgFilterBasedQuery<CfgObjectiveTable> {

    /**
     * Create query object with default filter value for configuration objects
     * of CfgObjectiveTable type. This query will not be executable.
     */
    public CfgObjectiveTableQuery() {
        super(CfgObjectType.CFGObjectiveTable);
        setObjectClass(CfgObjectiveTable.class);
    }

    /**
     * Create query object with default filter value for configuration objects
     * of CfgObjectiveTable type. If an instance of the configuration service
     * is provided, the query will be executable.
     *
     * @param service The configuration service to use when executing this query
     */
    public CfgObjectiveTableQuery(final IConfService service) {
        super(CfgObjectType.CFGObjectiveTable, service);
        setObjectClass(CfgObjectiveTable.class);
    }
     ...
     * @see #setDbid(int)
     */
    public CfgObjectiveTableQuery(final int dbid) {
        this();
        setDbid(dbid);
    }
     ...
     * @see #setName(String)
     */
    public CfgObjectiveTableQuery(final String name) {
        this();
        setName(name);
    }
     ...
     *
     * @return the CfgObjectiveTable object retrieved as a result of this operation
     */
    public CfgObjectiveTable executeSingleResult()
                    throws ConfigException {
        return super.executeSingleResult(CfgObjectiveTable.class);
    }

    /**
     * Executes the query and returns a list of CfgObjectiveTable objects.
     *
     * @return A collection of CfgObjectiveTable objects
     */
    public Collection<CfgObjectiveTable> execute()
                    throws ConfigException, InterruptedException {
        return super.execute(CfgObjectiveTable.class);
    }
     ...
     */
    public AsyncRequestResult<CfgObjectiveTable> beginExecute(
                final Action<AsyncRequestResult<CfgObjectiveTable>> callback,
                final Object state)
                    throws ConfigException {
        return super.beginExecute(CfgObjectiveTable.class, callback, state);
    }
    ...
    /**
     * Current state of an objective table (see
     * CfgObjectState
     * ). If specified, Configuration Server will return information only about objective tables that are currently in this state.
     *
