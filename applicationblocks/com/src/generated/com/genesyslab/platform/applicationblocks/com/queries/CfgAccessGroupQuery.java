 ...
 * @see com.genesyslab.platform.applicationblocks.com.objects.CfgAccessGroup
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgAccessGroupQuery extends CfgFilterBasedQuery<CfgAccessGroup> {

    /**
     * Create query object with default filter value for configuration objects
     * of CfgAccessGroup type. This query will not be executable.
     */
    public CfgAccessGroupQuery() {
        super(CfgObjectType.CFGAccessGroup);
        setObjectClass(CfgAccessGroup.class);
    }

    /**
     * Create query object with default filter value for configuration objects
     * of CfgAccessGroup type. If an instance of the configuration service
     * is provided, the query will be executable.
     *
     * @param service The configuration service to use when executing this query
     */
    public CfgAccessGroupQuery(final IConfService service) {
        super(CfgObjectType.CFGAccessGroup, service);
        setObjectClass(CfgAccessGroup.class);
    }
     ...
     * @see #setDbid(int)
     */
    public CfgAccessGroupQuery(final int dbid) {
        this();
        setDbid(dbid);
    }
     ...
     * @see #setName(String)
     */
    public CfgAccessGroupQuery(final String name) {
        this();
        setName(name);
    }
     ...
     *
     * @return the CfgAccessGroup object retrieved as a result of this operation
     */
    public CfgAccessGroup executeSingleResult()
                    throws ConfigException {
        return super.executeSingleResult(CfgAccessGroup.class);
    }

    /**
     * Executes the query and returns a list of CfgAccessGroup objects.
     *
     * @return A collection of CfgAccessGroup objects
     */
    public Collection<CfgAccessGroup> execute()
                    throws ConfigException, InterruptedException {
        return super.execute(CfgAccessGroup.class);
    }
     ...
     */
    public AsyncRequestResult<CfgAccessGroup> beginExecute(
                final Action<AsyncRequestResult<CfgAccessGroup>> callback,
                final Object state)
                    throws ConfigException {
        return super.beginExecute(CfgAccessGroup.class, callback, state);
    }
