 ...
 * @see com.genesyslab.platform.applicationblocks.com.objects.CfgSkill
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgSkillQuery extends CfgFilterBasedQuery<CfgSkill> {

    /**
     * Create query object with default filter value for configuration objects
     * of CfgSkill type. This query will not be executable.
     */
    public CfgSkillQuery() {
        super(CfgObjectType.CFGSkill);
        setObjectClass(CfgSkill.class);
    }

    /**
     * Create query object with default filter value for configuration objects
     * of CfgSkill type. If an instance of the configuration service
     * is provided, the query will be executable.
     *
     * @param service The configuration service to use when executing this query
     */
    public CfgSkillQuery(final IConfService service) {
        super(CfgObjectType.CFGSkill, service);
        setObjectClass(CfgSkill.class);
    }
     ...
     * @see #setDbid(int)
     */
    public CfgSkillQuery(final int dbid) {
        this();
        setDbid(dbid);
    }
     ...
     * @see #setName(String)
     */
    public CfgSkillQuery(final String name) {
        this();
        setName(name);
    }
     ...
     *
     * @return the CfgSkill object retrieved as a result of this operation
     */
    public CfgSkill executeSingleResult()
                    throws ConfigException {
        return super.executeSingleResult(CfgSkill.class);
    }

    /**
     * Executes the query and returns a list of CfgSkill objects.
     *
     * @return A collection of CfgSkill objects
     */
    public Collection<CfgSkill> execute()
                    throws ConfigException, InterruptedException {
        return super.execute(CfgSkill.class);
    }
     ...
     */
    public AsyncRequestResult<CfgSkill> beginExecute(
                final Action<AsyncRequestResult<CfgSkill>> callback,
                final Object state)
                    throws ConfigException {
        return super.beginExecute(CfgSkill.class, callback, state);
    }
