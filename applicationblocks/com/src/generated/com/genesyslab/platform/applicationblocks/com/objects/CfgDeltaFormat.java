...
/**
 * <p/>
 * The <code>CfgDeltaFormat</code> is applicable for Configuration
 * Library/Server release 5.1.5xx and later.
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgDeltaFormat extends CfgDelta {
     ...
     */
    public CfgDeltaFormat(final IConfService confService) {
        super(confService, "CfgDeltaFormat");
    }
    ...
    /**
     * The DBID of the target CfgFormat configuration object.
     *
     ...
     */
    public final CfgFormat retrieveCfgFormat() throws ConfigException {
        return (CfgFormat) (super.retrieveObject());
    }
     ...
     */
    public final Collection<CfgField> getAddedFields() {
     ...
     */
    public final Collection<Integer> getAddedFieldDBIDs() {
        return getLinkListCollection("fieldDBIDs");
    }

    /**
     * @deprecated
     * @see #getAddedFieldDBIDs()
     */
    @Deprecated
     ...
     * @return list of configuration objects or null
     */
    public final Collection<CfgField> getDeletedFields() {
        return (Collection<CfgField>) getProperty("deletedFieldDBIDs");
    }
     ...
     * @return collection of DBID identifiers of referred objects or null
     */
    public final Collection<Integer> getDeletedFieldDBIDs() {
        return getLinkListCollection("deletedFieldDBIDs");
    }
