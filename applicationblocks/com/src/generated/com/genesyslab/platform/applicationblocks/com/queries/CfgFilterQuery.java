 ...
 * @see com.genesyslab.platform.applicationblocks.com.objects.CfgFilter
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgFilterQuery extends CfgFilterBasedQuery<CfgFilter> {

    /**
     * Create query object with default filter value for configuration objects
     * of CfgFilter type. This query will not be executable.
     */
    public CfgFilterQuery() {
        super(CfgObjectType.CFGFilter);
        setObjectClass(CfgFilter.class);
    }

    /**
     * Create query object with default filter value for configuration objects
     * of CfgFilter type. If an instance of the configuration service
     * is provided, the query will be executable.
     *
     * @param service The configuration service to use when executing this query
     */
    public CfgFilterQuery(final IConfService service) {
        super(CfgObjectType.CFGFilter, service);
        setObjectClass(CfgFilter.class);
    }
     ...
     * @see #setDbid(int)
     */
    public CfgFilterQuery(final int dbid) {
        this();
        setDbid(dbid);
    }
     ...
     * @see #setName(String)
     */
    public CfgFilterQuery(final String name) {
        this();
        setName(name);
    }
     ...
     *
     * @return the CfgFilter object retrieved as a result of this operation
     */
    public CfgFilter executeSingleResult()
                    throws ConfigException {
        return super.executeSingleResult(CfgFilter.class);
    }

    /**
     * Executes the query and returns a list of CfgFilter objects.
     *
     * @return A collection of CfgFilter objects
     */
    public Collection<CfgFilter> execute()
                    throws ConfigException, InterruptedException {
        return super.execute(CfgFilter.class);
    }
     ...
     */
    public AsyncRequestResult<CfgFilter> beginExecute(
                final Action<AsyncRequestResult<CfgFilter>> callback,
                final Object state)
                    throws ConfigException {
        return super.beginExecute(CfgFilter.class, callback, state);
    }
