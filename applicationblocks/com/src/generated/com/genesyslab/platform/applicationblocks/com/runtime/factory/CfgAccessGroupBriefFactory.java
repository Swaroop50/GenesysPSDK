...
/**
 * Internal objects creation factory for CfgAccessGroupBrief type.
 *
...
public final class CfgAccessGroupBriefFactory
        implements ICfgObjectFactory {

    public Class<CfgAccessGroupBrief> getObjectType() {
        return CfgAccessGroupBrief.class;
    }
    ...
    public CfgBase create(
          ...
          return new CfgAccessGroupBrief(
                     confService, (ConfObjectBrief) objData, additionalParams);
    }
