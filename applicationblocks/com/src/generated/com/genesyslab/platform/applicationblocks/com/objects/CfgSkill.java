...
/**
 * <p/>
 * <em>Skills</em> are qualities or abilities that Agents possess. These Skills
 * affect how Agents are placed in a contact center hierarchy.
 * <p/>
 * Common skills include abilities in different languages, particular categories
 * of product knowledge, or ability in particular types of sales.
 *
 * <p/>
 * Deletion of Skill X will cause the following events
 * set out in the order of arrival:
 * <ul type="bullet">
 * <li>
 * Modification of <code>skillLevels</code> of all agents that
...
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:21-07:00")
public class CfgSkill
            extends CfgObject {

    public static final CfgObjectType OBJECT_TYPE = CfgObjectType.CFGSkill;
    ...
    public CfgSkill(
        ...
        if (objData.getObjectType() != OBJECT_TYPE) {
            throw new IllegalArgumentException(
                    "Incompatible object type for CfgSkill - "
     ...
     * @param confService configuration service instance
     */
    public CfgSkill(final IConfService confService) {
        super(confService,
    ...
    /**
     * A pointer to the name of the skill.
     ...
     * </code> that this skill belongs to. Mandatory. Once specified, cannot
     * be changed.
     *
