...
/**
 * Internal objects creation factory for CfgPersonLastLogin type.
 *
...
public final class CfgPersonLastLoginFactory
        implements ICfgObjectFactory {

    public Class<CfgPersonLastLogin> getObjectType() {
        return CfgPersonLastLogin.class;
    }
    ...
    public CfgBase create(
        ...
        return new CfgPersonLastLogin(
                   confService, (ConfObject) objData, true, additionalParams);
    }
