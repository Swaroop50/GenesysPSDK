...
public class CfgDeltaSkill extends CfgDelta {
     ...
     */
    public CfgDeltaSkill(final IConfService confService) {
        super(confService, "CfgDeltaSkill");
    }
    ...
    /**
     * The DBID of the target CfgSkill configuration object.
     *
     ...
     */
    public final CfgSkill retrieveCfgSkill() throws ConfigException {
        return (CfgSkill) (super.retrieveObject());
    }
