 ...
 * @see com.genesyslab.platform.applicationblocks.com.objects.CfgTimeZone
 */
@SuppressWarnings({"unused", "unchecked"})
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgTimeZoneQuery extends CfgFilterBasedQuery<CfgTimeZone> {

    /**
     * Create query object with default filter value for configuration objects
     * of CfgTimeZone type. This query will not be executable.
     */
    public CfgTimeZoneQuery() {
        super(CfgObjectType.CFGTimeZone);
        setObjectClass(CfgTimeZone.class);
    }

    /**
     * Create query object with default filter value for configuration objects
     * of CfgTimeZone type. If an instance of the configuration service
     * is provided, the query will be executable.
     *
     * @param service The configuration service to use when executing this query
     */
    public CfgTimeZoneQuery(final IConfService service) {
        super(CfgObjectType.CFGTimeZone, service);
        setObjectClass(CfgTimeZone.class);
    }
     ...
     * @see #setDbid(int)
     */
    public CfgTimeZoneQuery(final int dbid) {
        this();
        setDbid(dbid);
    }
     ...
     * @see #setName(String)
     */
    public CfgTimeZoneQuery(final String name) {
        this();
        setName(name);
    }
     ...
     *
     * @return the CfgTimeZone object retrieved as a result of this operation
     */
    public CfgTimeZone executeSingleResult()
                    throws ConfigException {
        return super.executeSingleResult(CfgTimeZone.class);
    }

    /**
     * Executes the query and returns a list of CfgTimeZone objects.
     *
     * @return A collection of CfgTimeZone objects
     */
    public Collection<CfgTimeZone> execute()
                    throws ConfigException, InterruptedException {
        return super.execute(CfgTimeZone.class);
    }
     ...
     */
    public AsyncRequestResult<CfgTimeZone> beginExecute(
                final Action<AsyncRequestResult<CfgTimeZone>> callback,
                final Object state)
                    throws ConfigException {
        return super.beginExecute(CfgTimeZone.class, callback, state);
    }
     ...
     *
     * @param value filter value on field "offset".
     */
     ...
     * that name.
     *
     * @param value filter value on field "name_netscape".
     */
    public final void setNameNetscape(final String value) {
        setProperty("name_netscape", value);
    }
     ...
     *
     * @param value filter value on field "name_msexplorer".
     */
    public final void setNameMsexplorer(final String value) {
        setProperty("name_msexplorer", value);
    }
