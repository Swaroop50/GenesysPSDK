...
/**
 * <p/>
 * <em>CfgOS</em> gives information about an operating system.
 */
@SuppressWarnings("unused")
@Generated(value="com.genesyslab.platform.applicationblocks.com.generator.COMGenerator",
           date="2024-07-23T09:23:22-07:00")
public class CfgOS extends CfgStructure {
    /**
     ...
     * @param parent instance of configuration object as a parent for this structure instance
     */
    public CfgOS(final IConfService confService, final ICfgObject parent) {
        super(confService, new ConfStructure(
                (CfgDescriptionStructure) confService.getMetaData()
                        .getCfgClass("CfgOSinfo")), parent);
    }
     ...
     * type <code>
     * <a href="../Enumerations/CfgOSType.html">CfgOSType</a>
     * </code>. Mandatory.
     *
     * @return property value or null
     */
    public final CfgOSType getOStype() {
        return (CfgOSType) getProperty(CfgOSType.class, "OStype");
    }
    ...
    public final String getOSversion() {
        return (String) getProperty("OSversion");
    }
