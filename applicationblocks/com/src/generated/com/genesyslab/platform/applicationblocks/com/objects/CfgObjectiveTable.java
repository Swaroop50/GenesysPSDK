...
/**
 * <p/>
 * <em>Objective Tables</em> are collections of Objective Records.
 *
 * <br/><br/><font size="+1"><strong>See also:</strong></font><p>
 * <a href="CfgDeltaObjectiveTable.html">
 * <b>CfgDeltaObjectiveTable</b>
 * </a>
 * </p>
 *
 * <p>
...
public class CfgObjectiveTable
    ...
    public static final CfgObjectType OBJECT_TYPE = CfgObjectType.CFGObjectiveTable;
    ...
    public CfgObjectiveTable(
        ...
        if (objData.getObjectType() != OBJECT_TYPE) {
            throw new IllegalArgumentException(
                    "Incompatible object type for CfgObjectiveTable - "
     ...
     * @param confService configuration service instance
     */
    public CfgObjectiveTable(final IConfService confService) {
        super(confService,
    ...
    public void save() throws ConfigException {
        if ((getConfigurationService() != null)
            ...
            if (getMetaData().getAttribute("objectiveRecords") != null) {
                Collection<CfgObjectiveTableRecord> objectiveRecords = (Collection<CfgObjectiveTableRecord>) getProperty("objectiveRecords");
                if (objectiveRecords != null) {
                    for (CfgObjectiveTableRecord item : objectiveRecords) {
     ...
     */
    @SuppressWarnings("unchecked")
    public final Collection<CfgObjectiveTableRecord> getObjectiveRecords() {
     ...
     *
     * @param value new property value
     * @see #getObjectiveRecords()
     */
    public final void setObjectiveRecords(final Collection<CfgObjectiveTableRecord> value) {
        setProperty("objectiveRecords", value);
    }
     ...
     * @see #getPrepaidCost()
     */
    public final void setPrepaidCost(final Integer value) {
        setProperty("prepaidCost", value);
    }
     ...
     * @see #getTimeStart()
     */
    public final void setTimeStart(final Calendar value) {
        if (isSaved()) {
            throw new ConfigRuntimeException(
                "Can't set this property because containing object has been saved.");
        }
        setProperty("timeStart", value);
    }
     ...
     * @see #getTimeEnd()
     */
    public final void setTimeEnd(final Calendar value) {
        setProperty("timeEnd", value);
    }
     ...
     * @see #getType()
     */
    public final void setType(final CfgObjectiveTableType value) {
        if (isSaved()) {
            throw new ConfigRuntimeException(
                "Can't set this property because containing object has been saved.");
        }
