...
/**
 * Platform SDK channel may invoke its handlers using default channel thread. 
 * However, if handler access UI component, the access should be done from UI thread.
 * To simplify UI component access from  UI thread, this invoker can be assigned 
 * to the channel.
 * 
