...
public class ReadConfigurationSamples {
     ...
     * This method also gets from the configuration server referred configuration application objects
     * and prints short information about that objects. This information is read on request
