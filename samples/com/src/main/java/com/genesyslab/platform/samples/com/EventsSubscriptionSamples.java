...
public class EventsSubscriptionSamples {
     ...
     * It is designed to show initialization and release steps
     * with required components (variables, interfaces) in clear static context
    ...
    public static void eventsStartAndStop4CfgApplication(
        ...
        // Release registration and subscription:
    ...
    static void testEvents(
		...
		System.out.println("Modify \'AppName4Test\' object in CME to see events.\n" +
